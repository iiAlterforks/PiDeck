...
- **zx3022448** ([@zx3022448](https://github.com/zx3022448)) — Model list fetch improvements and error states, model picker UX (#25, #19)
...
- **bfzha** ([@bfzha](https://github.com/bfzha)) — VS Code-style Git panel and complex workflows (#68)
